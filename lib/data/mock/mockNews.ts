...
### Fitur Baru yang Hadir:
1. **Jadwal Stream Interaktif**: Cek waktu tayang live stream lengkap dengan konverter zona waktu otomatis (WIB / JST / UTC).
2. **Ambient Sound Player**: Dengarkan alunan musik santai yang menemani kamu menjelajahi fanweb ini.
...
Pantau terus tab **Schedule** untuk detail jam tayangnya ya!`,
    category: "Milestone",
    author: "Purin Kokoa",
    publishedAt: "2026-08-25T18:00:00+07:00",
    coverImageUrl: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&auto=format&fit=crop&q=80",
    tags: ["50K", "Milestone", "Celebration"],
  },
  {
    id: "news_003",
    slug: "purin-merch-autumn-collection",
    title: "Preview Merchandise Eksklusif Musim Ini: Purin Acrylic Stand & Plushie!",
    excerpt: "Segera hadir merch edisi terbatas berupa standee akrilik Gunpla builder Purin dan gantungan kunci pudding menggemaskan!",
    content: `Koleksi merchandise resmi Purin edisi terbatas akan segera dibuka untuk pre-order!

### Item Merchandise:
* **Purin Gunpla Builder Acrylic Stand** (15cm High Quality Print)
* **Cocoa Pudding Plush Keychain** (Super soft & squishy)
* **Set Stiker Hologram Emote Lucu** (Isi 10 pcs)

Link pre-order akan dibuka melalui platform resmi dan info lengkap akan dibagikan via stream mendatang.`,
    category: "Merch",
    author: "Merch Team",
    publishedAt: "2026-08-20T12:00:00+07:00",
    coverImageUrl: "https://images.unsplash.com/photo-1563245372-f21724e3856d?w=800&auto=format&fit=crop&q=80",
    tags: ["Merch", "AcrylicStand", "Goods"],
  },
];
